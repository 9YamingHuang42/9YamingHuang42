...
Inheritance.model.6 <- glmmTMB(Inheritance ~ Cohort + Gender + (1|Mother_ID),
                               data = Inheritance.data,
                               family = binomial())

Inheritance.model.7 <- glmmTMB(Inheritance ~ Cohort + Gender + 
                                 Sibling.configuration + (1|Mother_ID),
                               data = Inheritance.data,
                               family = binomial())

Inheritance.model.8 <- glmmTMB(Inheritance ~ Cohort + Gender + 
...
Inheritance.model.10 <- glmmTMB(Inheritance ~ Cohort * Gender + 
                                  Sibling.configuration + Subsistence + (1|Mother_ID),
                                data = Inheritance.data,
                                family = binomial())
...
Inheritance.model.11 <- glmmTMB(Inheritance ~ Cohort + 
                                  Gender * Sibling.configuration +
                                   Subsistence + (1|Mother_ID),
                                 data = Inheritance.data,
                                 family = binomial())
summary(Inheritance.model.11)
Em.inheritance.model.11<- emmeans(Inheritance.model.11, ~ Gender * Sibling.configuration)
...
Inheritance.model.12 <- glmmTMB(Inheritance ~ Cohort + Sibling.configuration +
                                  Gender * Subsistence + (1|Mother_ID),
                                data = Inheritance.data,
                                family = binomial())
...
# Self-reported main category of each household’s expense  ----
Main.expense <- 
